...
/* The above code is a vertex shader. It is a program that runs on the GPU. It
 * is written in GLSL. */
...
/* Setting the version of OpenGL to use. */
  ...
  /* The above code is checking to see if the vertex shader compiled
  successfully. If it did not, it prints out the error message. */
  int success;
  char infoLog[512];
  ...
  /* The above code is checking to see if the fragment shader compiled
  successfully. If it did not, it prints out the error message. */
  if (!success) {
