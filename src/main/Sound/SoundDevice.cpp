...
/// </summary>
/// <param name="ori"> Return value: Must be a float array with 6 slots
/// available ex: float myvar[6]</param>
...
/// <summary>
/// Sets the orientation of our listener using 'look at' (or foward vector) and
/// 'up' direction
/// </summary>
...
void SoundDevice::SetOrientation(const float &atx, const float &aty,
